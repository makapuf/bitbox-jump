...
GAME_C_FILES = main.c intro.c level.c sounds.c jumper3.c lib/blitter/blitter.c lib/blitter/blitter_tmap.c lib/blitter/blitter_sprites.c lib/sampler/sampler.c
